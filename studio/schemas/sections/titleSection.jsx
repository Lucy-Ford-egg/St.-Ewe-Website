...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      description:
        'You can highlight the text and use the formatting to change the title size and colour.',
    }),
    defineField({
      ...
      type: 'boolean',
      description:
        'Check this if you wish for the title of the recipe to be pulled in with the "serves" subitle.',
    }),
    defineField({
      ...
      type: 'boolean',
      description:
        'Check this if you wish for the date of the post to be pulled in as a subtitle to the title on a post single page.',
    }),
    defineField({
    ...
    defineField({
      ...
      title: 'Alignment',
      description:
        'Aligns text to the grid. If set to left will replace the left asset. If unset defaults to center',
    }),
    defineField({
      title: 'Side Assets',
      name: 'sideAssets',
