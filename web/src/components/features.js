...
export const Features = ({ disableTopPadding, gridTitleSubtitleText, features, allFeature, pageContext}) => {
  ...
  return (
    <Container className="section features" maxWidth="xl" sx={{ pt: { xs: 10, md: 11 }}}>
      ...
      <TitleSubtitleText disableTopPadding={disableTopPadding} displayTitle={gridTitleSubtitleText?.displayTitle} subtitle={gridTitleSubtitleText?.subtitle} text={gridTitleSubtitleText?.text} titleSize={gridTitleSubtitleText?.titleSize} subtitlePosition={gridTitleSubtitleText?.subtitlePosition} titleWidth={gridTitleSubtitleText?.titleWidth}/>
