  ...
  return (
    <Container maxWidth="fluid" disableGutters={true}>
      <Box sx={{ height: {xs: '85vh', md: '85vh', lg: '765px'}, position: 'relative'}}>
        ...
        <Container maxWidth="xl" sx={{ position: "relative", zIndex: 2, bottom: 55, px: {xs: 2, sm: 4, md: 8}}}>
          <Box display="flex" flexDirection="row" justifyContent="flex-end" sx={{position: 'relative', right: 0, pb: {xs: 7} }}>
...
export const query = graphql`
  fragment GalleryCarouselFragment on SanityImageCarouselCaptionLink {
    ...
    carousel {
      caption
      asset {
        mainImage: gatsbyImageData(width: 1440, height: 765)
        thumbnail: gatsbyImageData(width: 1440, height: 765)
      }
    }
    carouselLinkGroup {
      internalLinkGroup {
