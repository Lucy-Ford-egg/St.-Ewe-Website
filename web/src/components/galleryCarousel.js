    ...
    <Container maxWidth="xl" disableGutters={true}>
      <Box sx={{ position: 'relative' }}>
        ...
        <Box display="flex" alignItems="center" flexDirection="column" sx={{ position: 'relative', height: '100%', bottom: 0, }}>
          ...
          <Box className="prev" onClick={(e) => paginate(1, e)} display="flex" alignItems="center" justifyContent="flex-end" sx={{ display: { xs: 'flex', md: 'flex' }, position: "absolute", zIndex: 2, height: '100%', top: '50%', right: 0, transform: 'translateY(-50%)', px: { xs: 7, sm: 4, md: 8 } }}>
        ...
        <Container maxWidth="xl" sx={{ position: "relative", zIndex: 2, bottom: {xs: clientTheme.spacing(6), md: clientTheme.spacing(10)}, px: { xs: 2, sm: 4, md: 8 }, pb: {xs: 9, md: 2} }}>
          <Box display="flex" flexDirection="row" justifyContent="center" sx={{ position: 'relative', right: 0, pb: { xs: 7 } }}>
            {carousel.map((dot, index) => {
              ...
              return (
                <SvgIcon sx={{width: {xs: 14, md: 14}, height: {xs: 14, md: 14}, mx: {xs: 3, md: 3} }} viewBox="0 0 8 8" color={dotColour} key={`dot-${index}`}>
        ...
        <Container maxWidth="xl" sx={{ display: {xs: 'none', md: 'block'}, position: "relative", zIndex: 2, bottom: clientTheme.spacing(10), py:{xs: 9, md: 6}, pr: {xs: 9, md: 0}, mr: {xs: 9, md:0 }, overflowX: 'hidden'}}>
