...
const Container = styled('div')(({ borderDirection, backgroundColour, joiningColour, mirror }) => ({
    gridColumn: '2/24',
    display: 'grid',
    gridTemplateColumns: 'subgrid',
}));
            ...
            <Wrapper backgroundColour={backgroundColour}>
                <Container>
                    ...
                    <Content alignment={alignment} backgroundColour={backgroundColour}>
                        ...
                        {isRecipe && (
                            <Typography color={contrastBrandPalette[backgroundColour?.label]?.contrastText} variant="h2" component="h1">{pageData?.sanityRecipes?.title}</Typography>
                        )}
                        {definedIsPost && (
                        ...
                        {isRecipe && (
                            <Typography color={contrastBrandPalette[backgroundColour?.label]?.contrastText} variant="body" sx={{
                                fontWeight: 900,
