...
export const HeroNewsletter = ({ title, text, image, linkGroup }) => {
  ...
  return (
    <Container className="section heroNewsletter" maxWidth="xl"  disableGutters={isMobile ? true : false} sx={{ px: {xs: 0}, pt: { xs: 10, md: 11 }, display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gridTemplateRows: {xs: '30px 1fr 1fr 1fr 30px', md: 'repeat(6, 1fr)'}, gridColumnGap: {xs: 0, md: 50} }}>
