...
const PlaceBuilder = ({ data, pageContext }) => {
  return (
    <>
      { data && <Modules allFeature={data.allSanityFeature.nodes} allPlace={data.allSanityPlace.nodes} allPost={data.allSanityPost.nodes} modules={data.sanityPlace.pageBuilder}/>}
    </>
  ) 
}
